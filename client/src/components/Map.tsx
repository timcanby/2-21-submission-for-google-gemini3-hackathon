...
// Singleton promise — ensures the Maps script is only injected once regardless of how many
// MapView instances mount simultaneously or in sequence.
...
function loadMapScript(): Promise<void> {
  ...
  _mapsLoadPromise = new Promise<void>((resolve, reject) => {
    // Double-check after acquiring the singleton slot
